...
from game.models import GameResult, CleanupAudit
...
def cleanup_stale_games():
    ...
    try:
        ...
        CleanupAudit.objects.create(
            status="success",
            stale_sessions_detected=deleted_count + resigned_count,
            sessions_removed=deleted_count,
            sessions_resigned=resigned_count,
            duration=duration
        )
